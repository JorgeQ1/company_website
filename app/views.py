...
from .models import GeneralInfo, Service, Testimonial, FrequentlyAskedQuestion, ContactFormLog, Blog
...
def index(request):
    ...
    context = {
        ...
        "company_location": getattr(general_info, "company_location", default_value),
